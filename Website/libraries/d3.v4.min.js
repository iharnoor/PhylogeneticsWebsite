...
(function (t, n) {
    ...
    function Fe(t) {
        ...
        return {
            format: n, formatPrefix: function (t, e) {
                var r = n((t = De(t), t.type = "newickField", t)), i = 3 * Math.max(-8, Math.min(8, Math.floor(Le(e) / 3))),
    ...
    function du(n) {
        ...
        return n.ticks = function (t) {
            ...
            return function (n, e, r) {
                ...
                switch ((r = De(null == r ? ",newickField" : r)).type) {
                    case"s":
    ...
    var Hh, jh = ["y", "z", "a", "newickField", "p", "n", "µ", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y"];
