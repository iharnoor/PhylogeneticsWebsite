...
{
       0,    95,    95,   107,   111,   115,   126,   133,   141,   141,
     142,   142,   143,   144
};
#endif
...
{
       0,     0,     0,     8,    12,     8,     0,     4,    10,     1,
      10,     9,    10,     3,     0,     0,     7,     0,     6,     5,
      13,    11,     2
};
...
{
       5,    -3,     9,     3,   -10,     3,     2,   -10,     4,   -10,
       4,   -10,     4,   -10,    -3,     6,   -10,     7,   -10,   -10,
     -10,   -10,   -10
};
...
{
       1,    17,    11,    18,    11,     4,    13,    14,     1,     9,
      15,     4,     3,     0,    22,    20,    12,     0,     0,     0,
       0,     0,    19
};

static const yytype_int8 yycheck[] =
{
       3,    10,     3,    12,     5,     8,     4,     5,     3,     0,
       6,     8,     0,    -1,     7,     9,     5,    -1,    -1,    -1,
      -1,    -1,    14
};
...
{
       0,     3,    11,    12,     8,    12,    13,    14,    17,     0,
      15,    17,    15,     4,     5,     6,    16,    16,    16,    14,
       9,    18,     7
};
...
#line 96 "newick.y"
    {
        Tree* tree=newTree();
        //tree->type=ROOT;
        tree->child=(yyvsp[(1) - (4)].tree);
        tree->label=(yyvsp[(2) - (4)].s);
        tree->length=(yyvsp[(3) - (4)].d);
        fputs("digraph G {\n",stdout);
...
#line 116 "newick.y"
    {
                Tree* last=(yyvsp[(1) - (3)].tree);
                (yyval.tree)=(yyvsp[(1) - (3)].tree);
                while(last->next!=NULL)
                        {
                        last=last->next;
                        }
                last->next=(yyvsp[(3) - (3)].tree);
                ;}
    break;
...
#line 127 "newick.y"
    {
                (yyval.tree)=newTree();
                (yyval.tree)->child=(yyvsp[(1) - (3)].tree);
                (yyval.tree)->label=(yyvsp[(2) - (3)].s);
                (yyval.tree)->length=(yyvsp[(3) - (3)].d);
                ;}
    break;
